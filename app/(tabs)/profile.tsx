...
const Profile = () => {
  ...
  const [image, setImage] = useState(user?.primaryWeb3WalletId);
    ...
    <View style={styles.container}>
      ...
      <View style={styles.profileContainer}>
        <TouchableOpacity
          ...
          <Image source={{ uri: `${image || user!.imageUrl}` }} style={styles.profile} />
        </TouchableOpacity>
        <Modal
          animationType="slide"
          transparent={true}
          ...
          <Pressable style={styles.centeredView} onPress={() => setModal(!modal)}>
            <View style={styles.modalView}>
              <TouchableOpacity onPress={() => setModal(!modal)}>
                <Image source={{ uri: `${image || user!.imageUrl}` }} style={styles.modalProfile} />
              </TouchableOpacity>
